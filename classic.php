...
<body>
   ...
   <br>
    ...
    <div class="text-center">
      <h4 class="showcase-h4">CLASSIC ONES THE BEST ONES!</h4>
</div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Classic'";
...
<div class="container">
      <div class="row">
         <div class="col-md-6  col-sm-12">
           <img src="images/class.jpeg" style="width:100%; max-height: 800px;  ">
         </div>
        
         <div class="col-md-6  col-sm-12">
           <img src="images/var.jpeg" style="width:100%; max-height: 800px;  ">
         </div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Classic1'";
      $query = mysqli_query($conn,$sql);
