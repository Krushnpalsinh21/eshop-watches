...
<body>
   ...
   <br>
    ...
    <div class="text-center">
      <h4 class="showcase-h4">The first step to being Respected is to look Respected!</h4>
</div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Menwatch'";
...
<div class="container">
      <div class="row">
         <div class="col-md-6  col-sm-12">
           <img src="images/nice.jpg" style="width:100%; max-height: 800px;  ">
         </div>
        
         <div class="col-md-6  col-sm-12">
           <img src="images/set.jpg" style="width:100%; max-height: 800px;  ">
         </div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Menwatchunder'";
      $query = mysqli_query($conn,$sql);
