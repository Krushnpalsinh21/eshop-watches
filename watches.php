...
<body>
   ...
   <br>
    ...
    <div class="text-center">
      <h4 class="showcase-h4">LUXUARY WATCHES WAITING TO BE YOURS!</h4>
</div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Watches'";
...
<div class="container">
      <div class="row">
         <div class="col-md-6  col-sm-12">
            <a class="showcase-image" href="menswatch.php"><img src="images/men.jpg" style="width:100%; max-height: 800px;  "></a>
         </div>
        
         <div class="col-md-6  col-sm-12">
           <a class="showcase-image" href="womenwatch.php"><img src="images/women.jpg" style="width:100%; max-height: 800px;  "></a>
         </div>
  ...
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Watchunder'";
      $query = mysqli_query($conn,$sql);
