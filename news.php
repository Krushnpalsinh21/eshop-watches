...
<div class="new"></div>
<!-- <img  src="images/ncoll.jpg" style="width: 100%; max-height:600px;"> -->
...
<div class="text-center">
      <h4 class="showcase-h4">THE NEW COLLECTION HAS ARRIVED GO CHECK!</h4>
</div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'News'";
...
<div class="text-center">
      <h4 class="showcase-h4">THE NEW LUXUARY COLLECTION HAS ARRIVED! </h4>
</div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'Luxuary'";
      $query = mysqli_query($conn,$sql);
...
<div class="container">
      <div class="row">
         <div class="col-md-6  col-sm-12">
           <img src="images/wd.jpeg" style="width:100%; max-height: 800px;  ">
         </div>
        
         <div class="col-md-6  col-sm-12">
           <img src="images/qant.jpeg" style="width:100%; max-height: 800px;  ">
         </div>
  ...
  <div class="text-center">
      <h4 class="showcase-h4">NEW COLLECTIONS ARE HEREEE! </h4>
</div>
...
<div class="container-fluid">
  <div class="row">
    ...
    <?php
      $sql = "SELECT * FROM products WHERE type = 'New1'";
      $query = mysqli_query($conn,$sql);
